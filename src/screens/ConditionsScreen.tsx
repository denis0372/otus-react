  ...
  render() {
    return (
      <div>
        ...
        <button id="save_btn" onClick={this.props["conditionEdit"]}>
          загрузить
        </button>
        <button id="save_btn" onClick={this.props["conditionSave"]}>
          сохранить
        </button>
...
export const ConditionsScreen = connect(
  mapStateToProps,
  mapDispatchToProps
)(authorizedOnlyHoc(RawConditionsScreen, "/login"));
